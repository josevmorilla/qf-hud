"Scheme"
{
	...
	{   
        ...
        "QuakeFortressMenuAccent"   "129 130 178 255"
        "AccentBright"  "131 108 196 255"
        "AccentMid"     "127 116 179 255"
        "AccentDark"    "104 81 148 255"

        "QuakeOffWhite" "220 220 220 255"
        "LightGrey"     "51 51 51 255"
        "MidGrey"       "35 34 32 255"
        "DarkGrey"      "27 26 24 255"
        "VeryDarkGrey"  "15 15 15 255"
		...
		//=========================================================================================================================
		"SS_Frame_Active"									"3 1 8 255" // main window background
		"SS_Frame_Inactive"									"3 1 8 255"

		"SS_Title"											"255 255 255 255"
		"SS_Title_Disabled"									"220 220 220 255"

		"SS_ListBG"											"0 0 0 100"
		"SS_List_Text"										"220 220 220 255"
		"SS_List_Text_Armed"								"0 0 0 255"
		"SS_List_Button"									"27 26 24 255"         // server list background & options menu background
		"SS_List_Button_Armed"								"127 116 179 255"

		"SS_Button_Text"									"220 220 220 255"
		"SS_Button_Text_Armed"								"0 0 0 255"
		"SS_Button_BG"										"51 51 51 255"       // button backgrounds
		"SS_Button_BG_Armed"								"127 116 179 255"

		"SS_Sheet_Text"										"220 220 220 255"
		"SS_Sheet_Text_Selected"							"220 220 220 255"

		"SS_CloseButton"									"220 220 220 255"

        // right click menu also does dropdown lists
		"SS_RightClick_Menu_Text"							"0 0 0 255"
		"SS_RightClick_Menu_Text_Armed"						"0 0 0 255"
		"SS_RightClick_Menu_BG"								"51 51 51 255"
		"SS_RightClick_Menu_BG_Armed"						"127 116 179 255"
		"SS_RightClick_Menu_Divider"						"220 220 220 255"

		"SS_CheckButton_Text"								"220 220 220 255"
		"SS_CheckButton_Text_Armed"							"131 108 196 255"
		"SS_CheckButton_BG"									"15 15 15 255"
		"SS_CheckButton_Armed"								"220 220 220 255"   // checkbox tick

		"SS_Combobox_BG"									"15 15 15 255"
		"SS_Combobox_Arrow"									"220 220 220 255"
		"SS_Combobox_Arrow_Armed"							"220 220 220 255"

		"SS_Slider_Nob"										"127 116 179 255"
		"SS_Slider_Text"									"220 220 220 255"
		"SS_Slider_Text_Disabled"							"180 180 180 255"
		"SS_Slider_BG"										"35 34 32 255"

		"SS_Label"											"220 220 220 255"
		"SS_Label_Selected"									"220 220 220 255"
		...
		"SS_Text_Entry"										"220 220 220 255"   // text box text
		"SS_Text_Entry_Selected"							"18 15 14 255"      // text box highlighted text
		"SS_Text_Entry_BG"									"15 15 15 255"         // text box background
		"SS_Text_Entry_BG_Selected"							"127 116 179 255"   // text box selected text bg

		"SS_Console_Text_BG"								"27 26 24 255"         // console background
		"SS_Console_Text_Selected"							"18 15 14 255"      // selected text in console
		"SS_Console_Text_BG_Selected"						"127 116 179 255"    // selected text in console bg
		"SS_Console_User_Input"								"131 108 196 255"    // text in console that was typed by user
...
//			}
	...
	BaseSettings
	{
        ...
        // settings menu
		"SectionedListPanel.HeaderTextColor"				"220 220 220 255"
